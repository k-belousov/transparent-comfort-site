...
export const About = () => {
  ...
  return (
    <section className="py-20 bg-card" aria-labelledby="about-title">
      <h2 id="about-title" className="sr-only">О компании Прозрачный комфорт</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6 font-sans leading-relaxed">
                9 лет создаём мягкие окна, которые служат годами. Наши клиенты ценят аккуратность, точность и честность.
              </p>
              <p className="text-lg text-muted-foreground font-sans leading-relaxed mb-6">
                Каждый проект выполняем с особым вниманием к деталям, используя только проверенные материалы высокого качества и современное оборудование.
              </p>
              <p className="text-lg text-muted-foreground font-sans leading-relaxed">
                Работаем по всей Челябинской области.
              </p>
            </div>
            ...
            >
              <img
                src={craftsmanImage}
                alt="Мастер-установщик компании Прозрачный комфорт выполняет замер мягких окон в Челябинске"
